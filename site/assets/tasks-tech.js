...
/* ================= постройка судна и стандартный проект ================= */
{
  ...
  items: [
    { s: 'How is a cargo ship different from a car?',
      opts: [
        { t: 'It is constructed following the demands of the shipping company.', ok: true, why: 'судно строят под заказчика, а не выбирают из модельного ряда.' },
        { t: 'It is ready for delivery in a wide range of models.', why: 'это как раз про автомобиль, а не про грузовое судно.' },
        { t: 'It needs no drawings at all.', why: 'чертежей у судна во много раз больше, чем у автомобиля.' },
      ] },
    { s: 'What happens prior to the actual construction of the ship?',
      opts: [
        { t: 'The company, the financer and the owners complete a trajectory of negotiations.', ok: true, why: 'до резки первого листа проходят месяцы переговоров и расчётов.' },
...
},
{
  ...
  items: [
    { s: 'The clients know what they can ___.', a: [['expect']] },
    { s: 'The design has already proven itself and, if necessary, has been ___.',
      a: [['improved']] },
    { s: 'The design may not be entirely ___ for the shipping company.',
      a: [['suitable']] },
    { s: 'The price of the construction is exactly ___.', a: [['known']] },
    { s: 'The almost complete absence of the design period ___ the delivery period.',
      a: [['shortens']] },
    { s: 'The involvement of the shipping company is ___ to only details.',
      a: [['limited']] },
    { s: 'The overall ___ are lower.', a: [['costs']] },
  ],
...
},
{
  ...
  items: [
    { t: 'the clients know what they can expect', c: 'a' },
    { t: 'the design has already proven itself', c: 'a' },
    { t: 'the price of the construction is exactly known', c: 'a' },
    { t: 'the absence of the design period shortens the delivery', c: 'a' },
    { t: 'the overall costs are lower', c: 'a' },
    { t: 'the design may not be entirely suitable for the company', c: 'd' },
    { t: 'the involvement of the shipping company is limited to details', c: 'd' },
  ],
...
},
{
  ...
  lines: [
    ...
    'As the design has already proven itself, the price is exactly known.',
    'The almost complete absence of the design period shortens the delivery.',
    'The overall costs are therefore lower.',
    'However, the involvement of the owner is limited to details.',
  ],
...
/* ================= сварка и соединения ================= */
{
  ...
  items: [
    ...
    { s: 'What does ten per cent less steel in the hull mean for the owner?',
      opts: [
        { t: 'Ten per cent more cargo for the same displacement.', ok: true, why: 'выигрыш в весе корпуса прямо превращается в грузоподъёмность.' },
...
},
{
  ...
  items: [
    { s: 'Until the middle of the twentieth century the plates were joined ___ rivets.',
      a: [['by', 'with']] },
...
},
{
  ...
  items: [
    { ru: 'Шов такой же прочный и такой же непроницаемый, как сам лист.',
      a: 'The joint is as strong and as watertight as the plate itself.', extra: ['than'] },
...
},
{
  ...
  items: [
    { ru: 'В дуговой сварке электрическая дуга горит между электродом и изделием.',
      a: 'In arc welding an electric arc burns between the electrode and the work.',
      extra: ['arcs'] },
    { ru: 'Два листа, лежащие в одной плоскости, дают стыковое соединение.',
      a: 'Two plates that lie in the same plane give a butt joint.', extra: ['lying'] },
  ],
